const CACHE='five-words-v0.1.3-byok';
const ASSETS=['./','./index.html','./styles.css','./app-core.js','./app-lesson.js','./app-calendar.js','./app-learned.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
